...
export const august: MonthPlan = {
  ...
  products: [
    {
      id: "AS1: accoコラボ秋ニット", name: "acco コラボ 秋ニット",
    ...
    {
      id: "AS2: ファンネルネックニットWP", name: "ファンネルネックニットWP",
    ...
    {
      id: "AS3: カーブパンツ（秋色）", name: "カーブシルエットパンツ（秋色）",
    ...
    {
      id: "AA1: フリルカラーブラウス", name: "フリルカラーブラウス",
    ...
    {
      id: "AA2: レースドッキング秋カミ", name: "レースドッキング 秋カラーキャミ",
    ...
    {
      id: "AA3: ニットロングスカート", name: "ニットロングスカート",
